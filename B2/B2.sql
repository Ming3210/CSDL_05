...
select product_id, product_name, price, price * 1.1 AS new_price
from products;
...
select product_id, product_name, price, stock_quantity, price * stock_quantity as total_stock_value
from products;
